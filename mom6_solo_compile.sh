root=/lustre/lysun/models/MOM6-test/MOM6-examples

#template=${root}/src/mkmf/templates/ncrc-intel.mk
template=${root}/src/mkmf/templates/dt2-intel.mk
DO_NO_SIS2=false
...
(cd ${root}/build/intel/shared/repro/; source ${root}/build/intel/env; make NETCDF=3 REPRO=1 libfms.a -j)
